...
public class CalendarController implements Initializable {
    ...
    private void handleChatButton() {
        switchScene("AboutYouStudent.fxml", 1200, 700, Chat);
    }
    ...
    private HashMap<String, String[]> showStudentActivities(int studentId) {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        activties_db = showStudentActivities(getStudentId(UserCredentials.getUsername(), UserCredentials.getPassword()));
    ...
    private void drawCalendar() {
        System.out.println("Luna din calendar este: "+dateFocus.getMonthValue());
        calendar.getChildren().clear();
